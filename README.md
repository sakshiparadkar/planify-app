...
2)To implement time-based and event-based task reminders

3)To provide a user-friendly interface for task management

4)To track and visualize weekly performance
...
✨Reminder timers are scheduled using JavaScript
...
git clone https://github.com/<your-github-username>/planify-app.git
...
2.Handling date & time operations

3.Designing user-centric UI/UX
